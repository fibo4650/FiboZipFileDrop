...
You can use **"Copy as markdown"** to save it directly into your project repository.
...
3. **File Header Standard:** Apply the 2-line header comment standard to any updated or newly created JS file:
